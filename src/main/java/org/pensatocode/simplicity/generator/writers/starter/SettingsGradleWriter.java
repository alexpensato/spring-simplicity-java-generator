...
public class SettingsGradleWriter implements FileSourceWriter {
    ...
    public SettingsGradleWriter(VelocityEngine velocityEngine, DirectoryService dirService, Starter starterProps) {
    ...
    public boolean generateFileSource() {
        ...
        velocityContext.put("projectName", starterProps.getProjectName());
